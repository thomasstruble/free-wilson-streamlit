...
st.selectbox('Please choose the column you want to run with free wilson', df.select_dtypes('float64').columns)

# core_smiles = "c1ccc(C2CC3CCC(C2)N3)cc1"
# core_mol = Chem.MolFromSmiles(core_smiles)

core_smiles = st.text_input('Input your Core SMILES here', placeholder="c1ccc(C2CC3CCC(C2)N3)cc1")
if not core_smiles:
    core_smiles = "c1ccc(C2CC3CCC(C2)N3)cc1"
...
#     return components.html(rs_html, width=900, height=300, scrolling=True)
